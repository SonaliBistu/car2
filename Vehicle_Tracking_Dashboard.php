...
<div class="dashboard">
    ...
    <aside class="sidebar">
        ...
        <ul>
            ...
            <li><a href="Vehicle_Mileage_Report.html"><i class="fa fa-file"></i> Reports </a></li>
            <li><a href="logs_data.php"><i class="fa fa-user"></i> Log Data</a></li>
            <li><a href="dashboard.php"><i class="fa fa-sign-out-alt"></i> Logout</li>
        </ul>
    </aside>
